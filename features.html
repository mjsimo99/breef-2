...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- For favicon png -->
		<link rel="shortcut icon" type="image/icon" href="assets/logo/sinewhite.png"/>
				        ...
				        <div class="container">            
				                    ...
				                    <li class="dropdown">
				                        ...
				                        <ul class="dropdown-menu cart-list s-cate">
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="assets/images/collection/arrivals1.png" class="cart-thumb" alt="collection1" /></a>
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="assets/images/collection/arrivals2.png" class="cart-thumb" alt="collection2" /></a>
				                                <div class="cart-list-txt">
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="assets/images/collection/arrivals3.png" class="cart-thumb" alt="collection3" /></a>
				                                <div class="cart-list-txt">
				            ...
				            <div class="navbar-header">
								...
								<a class="navbar-brand" href="index.html">
									<img src="Sinemkt.png" alt="SineMkt"  >
								</a>
						...
						<div class="col-sm-3">
							<div class="single-feature">
								...
								<div class="single-feature-txt text-center">
									...
									<h3><a href="#">chair sofa modern</a></h3>
									<h5>$100.00</h5>
								</div>
							</div>
						</div>
